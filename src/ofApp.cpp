...
//    //読み込む画像のパス
//    cv::String scene1_path = "/Users/Shin/Desktop/2coin1.JPG";
//    cv::String scene2_path = "/Users/Shin/Desktop/2coin2.JPG";
//    
//    //書き出す画像のパス
//    cv::String scene_12_path = "/Users/Shin/Desktop/2coin12.jpg";
//    
//    
...
//    cv::imwrite(scene_12_path, dest);
    ...
    for (;;)
    {
        ...
        akaze->detectAndCompute(edges, cv::noArray(), keypoints, descriptors);
        
        cv::drawKeypoints(edges, keypoints, edges);
